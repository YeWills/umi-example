      ...
      },
      {
        ...
        "routes": [
          ...
          },
          {
            "path": "/list/Count",
            "exact": true,
            "component": require('../list/Count.js').default
          },
          {
            "path": "/list/list",
            "exact": true,
          ...
          {
            "component": () => React.createElement(require('E:/dav-umi/with-dva/node_modules/umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: false })
          }
        ]
      },
      {
